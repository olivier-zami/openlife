...
SimpleVector<DemoCodeChecker *> oldCodeCheckers;// track old code checkers so that we can destroy them after they unblock
DemoCodePanelKeyboardHandler *codeCheckerKeyHandler;

void DemoCodePanelKeyboardHandler::keyPressed( unsigned char inKey, int inX, int inY ) {
